...
fn main() {
    let restaurant1 = Restaurant{reservations: 11, has_mice_infestation: true};
    println!("{:?}", restaurant1.chef_special());
    println!("{:?}", restaurant1.deliver_burger("123 Elm Street"));
    
    let restaurant2 = Restaurant{reservations: 15, has_mice_infestation: false};
    println!("{:?}", restaurant2.chef_special());
    println!("{:?}", restaurant2.deliver_burger(""));
    println!("{:?}", restaurant2.deliver_burger("123 Elm Street"));
}
